...
(function () {
    ...
    var basicBot = {
	    ...
	    dance1Command: {
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/ZDawAwF.webm", {link: "http://i.imgur.com/ZDawAwF.webm"}));
            	}
            },
            dance2Command: {
            	command: 'dance2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/H9nADqS.gif", {link: "http://i.imgur.com/H9nADqS.gif"}));
            	}
            },
            dance3Command: {
            	command: 'dance3',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/t71qeT1.gif", {link: "http://i.imgur.com/t71qeT1.gif"}));
            	}
            },
            dance4Command: {
            	command: 'dance4',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/TqezZCP.gif", {link: "http://i.imgur.com/TqezZCP.gif"}));
            	}
            },
            dance5Command: {
            	command: 'dance5',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/XnCeorl.gif", {link: "http://i.imgur.com/XnCeorl.gif"}));
            	}
            },
                sourceCommand: {
            	command: 'source',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat('The open source bot is available at: https://github.com/Paradox68/iScape-Bot'));
            	}
            },
            dance6Command: {
            	command: 'dance6',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/IUoOZDo.gif", {link: "http://i.imgur.com/IUoOZDo.gif"}));
            	}
            },
            dance7Command: {
            	command: 'dance7',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/jKfD4m3.gif", {link: "http://i.imgur.com/jKfD4m3.gif"}));
            	}
            },
            dance8Command: {
            	command: 'dance8',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/pIxt2H0.gif", {link: "http://i.imgur.com/pIxt2H0.gif"}));
            	}
            },
            dance9Command: {
            	command: 'dance9',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/YieC5Ls.gif", {link: "http://i.imgur.com/YieC5Ls.gif"}));
            	}
            },
            dance10Command: {
            	command: 'dance10',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/cKT7CNU.gif", {link: "http://i.imgur.com/cKT7CNU.gif"}));
            	}
            },
            dance11Command: {
            	command: 'dance11',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/6vfolCh.gif", {link: "http://i.imgur.com/6vfolCh.gif"}));
            	}
            },
            dance12Command: {
            	command: 'dance12',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/pQLee14.gif", {link: "http://i.imgur.com/pQLee14.gif"}));
            	}
            },
            dance13Command: {
            	command: 'dance13',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/sCGlr4m.gif", {link: "http://i.imgur.com/sCGlr4m.gif"}));
            	}
            },
            dance14Command: {
            	command: 'dance14',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/Q7T2K8o.gif", {link: "http://i.imgur.com/Q7T2K8o.gif"}));
            	}
            },
            faggot1Command: {
            	command: 'faggot1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/QJNr8sP.jpg', {link: "http://i.imgur.com/QJNr8sP.jpg'}));
            	}
            },
            faggot2Command: {
            	command: 'faggot2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/9We2dVP.gif", {link: "http://i.imgur.com/9We2dVP.gif"}));
            	}
            },
            faggot3Command: {
            	command: 'faggot3',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/JSZQTpU.gif", {link: "http://i.imgur.com/JSZQTpU.gif"}));
            	}
            },
            faggot4Command: {
            	command: 'faggot4',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/HfQ3gRA.gif", {link: "http://i.imgur.com/HfQ3gRA.gif"}));
            	}
            },
            faggot5Command: {
            	command: 'faggot5',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/uFLW7YK.gif", {link: "http://i.imgur.com/uFLW7YK.gif"}));
            	}
            },
            faggot6Command: {
            	command: 'faggot6',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/hbAtPOA.gif", {link: "http://i.imgur.com/hbAtPOA.gif"}));
            	}
            },
            faggot7Command: {
            	command: 'faggot7',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/g9rZoWs.gif", {link: "http://i.imgur.com/g9rZoWs.gif"}));
            	}
            },
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/WvvxQTk.gif", {link: "http://i.imgur.com/WvvxQTk.gif"}));
            	}
            },
              fuckyou1Command: {
            	command: 'fuckyou1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/1eh3dg1.gif", {link: "http://i.imgur.com/1eh3dg1.gif"}));
            	}
            },
            fuckyou2Command: {
            	command: 'fuckyou2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/Oh8h3Pt.gif", {link: "http://i.imgur.com/Oh8h3Pt.gif"}));
            	}
            },
            fuckyou3Command: {
            	command: 'fuckyou3',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/NH7LYM9.gif", {link: "http://i.imgur.com/NH7LYM9.gif"}));
            	}
            },
            fuckyou4Command: {
            	command: 'fuckyou4',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/NtdtELQ.gif", {link: "http://i.imgur.com/NtdtELQ.gif"}));
            	}
            },
            fuckyou5Command: {
            	command: 'fuckyou5',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/qE3MNo5.gif", {link: "http://i.imgur.com/qE3MNo5.gif"}));
            	}
            },
            fuckyou6Command: {
            	command: 'fuckyou6',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/AyObzfk.webm", {link: "http://i.imgur.com/AyObzfk.webm"}));
            	}
            },
            fuckyou7Command: {
            	command: 'fuckyou7',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/jCUu9nY.webm", {link: "http://i.imgur.com/jCUu9nY.webm"}));
            	}
            },
            fuckyou8Command: {
            	command: 'fuckyou8',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/WR4g4S7.gif", {link: "http://i.imgur.com/WR4g4S7.gif"}));
            	}
            },
            fuckyou9Command: {
            	command: 'fuckyou9',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/ntV8Vvg.gif", {link: "http://i.imgur.com/ntV8Vvg.gif"}));
            	}
            },
            fuckyou10Command: {
            	command: 'fuckyou10',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/btXKV0w.webm", {link: "http://i.imgur.com/btXKV0w.webm"}));
            	}
            },
            fuckyou11Command: {
            	command: 'fuckyou11',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/wlTqw2a.gif", {link: "http://i.imgur.com/wlTqw2a.gif"}));
            	}
            },
            jamesCommand: {
            	command: 'james',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/BvApgZl.gif", {link: "http://i.imgur.com/BvApgZl.gif"}));
            	}
            },
            bugdjCommand: {
            	command: 'bug',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/vYEOrkT.png', {link: "http://i.imgur.com/vYEOrkT.png'}));
            	}
            },
            penisCommand: {
            	command: 'penis',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/c4BWZyz.webm", {link: "http://i.imgur.com/c4BWZyz.webm"}));
            	}
            },
           allowitCommand: {
            	command: 'allowit',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/EI6OEYh.gif", {link: "http://i.imgur.com/EI6OEYh.gif"}));
            	}
            },
               refresh1Command: {
            	command: 'refresh1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/MWnOXM6.gif", {link: "http://i.imgur.com/MWnOXM6.gif"}));
            	}
            },
               fuckthis1Command: {
            	command: 'fuckthis1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/GMEMmZj.webm", {link: "http://i.imgur.com/GMEMmZj.webm"}));
            	}
            },
            shutup1Command: {
            	command: 'shutup1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/u1dIcAN.webm", {link: "http://i.imgur.com/u1dIcAN.webm"}));
            	}
            },
            hilarious1Command: {
            	command: 'hilarious1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/ZgFcDJE.webm", {link: "http://i.imgur.com/ZgFcDJE.webm"}));
            	}
            },
            gloryhole1Command: {
            	command: 'gloryhole1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/tdqZwhp.webm", {link: "http://i.imgur.com/tdqZwhp.webm"}));
            	}
            },
            ...
            bad1Command: {
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/WUOLKkl.webm", {link: "http://i.imgur.com/WUOLKkl.webm"}));
            	}
            },
            bad2Command: {
            	command: 'bad2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/5GG2m93.webm", {link: "http://i.imgur.com/5GG2m93.webm"}));
            	}
            },
            bad3Command: {
            	command: 'bad3',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/Tw5MCuB.gif", {link: "http://i.imgur.com/Tw5MCuB.gif"}));
            	}
            },
            bad4Command: {
            	command: 'bad4',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/81PvIBS.webm", {link: "http://i.imgur.com/81PvIBS.webm"}));
            	}
            },
            bad5Command: {
            	command: 'bad5',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/New6lgb.gif", {link: "http://i.imgur.com/New6lgb.gif"}));
            	}
            },
            feelbad1Command: {
            	command: 'feelbad1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/L8SLyYp.gif", {link: "http://i.imgur.com/L8SLyYp.gif"}));
            	}
            },
            clap1Command: {
            	command: 'clap1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/ljp2oIK.webm", {link: "http://i.imgur.com/ljp2oIK.webm"}));
            	}
            },
            clap2Command: {
            	command: 'clap2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/EewRcj5.webm", {link: "http://i.imgur.com/EewRcj5.webm"}));
            	}
            },
            brofist1Command: {
            	command: 'brofist1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/lIpVeN0.gif", {link: "http://i.imgur.com/lIpVeN0.gif"}));
            	}
            },
            hangyourself1Command: {
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/e2KTFEV.jpg', {link: "http://i.imgur.com/e2KTFEV.jpg'}));
            	}
            },
            laugh1Command: {
            	command: 'laugh1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/JJXmxnr.jpg', {link: "http://i.imgur.com/JJXmxnr.jpg'}));
            	}
            },
            laugh2Command: {
            	command: 'laugh2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/LUU1tI9.jpg', {link: "http://i.imgur.com/LUU1tI9.jpg'}));
            	}
            },
            laugh3Command: {
            	command: 'laugh3',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/qwhQw6r.gif", {link: "http://i.imgur.com/qwhQw6r.gif"}));
            	}
            },
            sad1Command: {
            	command: 'sad1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subchat("@" + chat.un + "\n http://i.imgur.com/B9DaCjz.webm", {link: "http://i.imgur.com/B9DaCjz.webm"}));
            	}
            },
            djdoge1Command: {
            	command: 'djdoge',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/N6Mb74t.jpg', {link: "http://i.imgur.com/N6Mb74t.jpg'}));
            	}
            },
            rodge1Command: {
            	command: 'rodge',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/YTThds9.jpg', {link: "http://i.imgur.com/YTThds9.jpg'}));
            	}
            },
            noregrets1Command: {
            	command: 'noregrets1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/rbFPzbB.webm", {link: "http://i.imgur.com/rbFPzbB.webm"}));
            	}
            },
            thefuck1Command: {
            	command: 'thefuck1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/nIbnCPv.gif", {link: "http://i.imgur.com/nIbnCPv.gif"}));
            	}
            },
            good1Command: {
            	command: 'good1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/FhBFNSO.gif", {link: "http://i.imgur.com/FhBFNSO.gif"}));
            	}
            },
            no1Command: {
            	command: 'no1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/5dXFx43.gif", {link: "http://i.imgur.com/5dXFx43.gif"}));
            	}
            },
            why1Command: {
            	command: 'why1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/w4E0ICB.webm", {link: "http://i.imgur.com/w4E0ICB.webm"}));
            	}
            },
            why2Command: {
            	command: 'why2',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/vi7Nc9o.webm", {link: "http://i.imgur.com/vi7Nc9o.webm"}));
            	}
            },
            brohug1Command: {
            	command: 'brohug1',
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/yvIbI7U.gif", {link: "http://i.imgur.com/yvIbI7U.gif"}));
            	}
            },
            ...
            bye1Command: {
            	...
            	functionality: function (chat, cmd) {
            	    if (this.type === 'exact' && chat.message.length !== cmd.length) { return void (0); }
                    	API.sendChat(subChat("@" + chat.un + "\n http://i.imgur.com/d61Aszu.webm", {link: "http://i.imgur.com/d61Aszu.webm"}));
            	}
            },
